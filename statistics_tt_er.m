...
file_folder = "../output/two_tranches/";
...
for junior = 0:0.05:1
    ...
    for i = 2:3
        data_1 = data((data(:, 4)==1), 1);
        data_2 = data_base_1((data_base_1(:, 4)==1), 1);
        data_3 = data((data(:, 3+i)==1), 1);
        data_4 = data_base_1((data_base_1(:, 3+i)==1), 1);
